...
public class View {
    ...
    public View() throws IOException {
        ...
        buttonTest = UIHelpers.createJButton(buttonTest, sizes.getButton_view_buttonTest_buttonX(), sizes.getButton_view_buttonTest_buttonY(), sizes.getButton_view_buttonTest_buttonWidth(), sizes.getButton_view_buttonTest_buttonHeight(), controller.getAppPropertiesWithKey("button.view.buttonTest"), Color.red);
